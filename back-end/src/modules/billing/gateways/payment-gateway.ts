...
import { CreateCheckoutInput, PLAN_PRICING, PlanBillingCycle } from '../dtos/billing.dto.js';
...
export interface IPaymentGateway {
  createSubscription(
    customer: { id: string; name: string; email: string; cpfCnpj: string; phone?: string },
...
export class AsaasPaymentGateway implements IPaymentGateway {
  ...
  async createSubscription(
    ...
    const cycleMap: Record<PlanBillingCycle, string> = {
      MONTHLY: 'MONTHLY',
      QUARTERLY: 'QUARTERLY',
